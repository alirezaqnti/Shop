...
urlpatterns = [
    ...
    path("pets/", views.HomepagepetsView.as_view(), name="HomepagepetsView"),
    path("fishing/", views.HomepagefishingView.as_view(), name="HomepagefishingView"),
    path("cosmetics/", views.HomepagecosmeticsView.as_view(), name="HomepagecosmeticsView"),
    path("contact-us/", views.ContactView.as_view(), name="ContactView"),
    path("purchase-track/", views.PurchaseTrackingView.as_view(), name="PurchaseTrackingView"),
    ...
    path("slide/<str:RS>", views.SliderDataView.as_view(), name="SliderDataView"),
]
