    ...
    if (l.console = l.console || {
        ...
        var t = {
                ...
                btnTpl: {
                    ...
                    zoom: '<button data-fancybox-zoom class="fancybox-button fancybox-button--zoom" title="{{ZOOM}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.7 17.3l-3-3a5.9 5.9 0 0 0-.6-7.6 5.9 5.9 0 0 0-8.4 0 5.9 5.9 0 0 0 0 8.4 5.9 5.9 0 0 0 7.7.7l3 3076D22AAC4"/></svg></button>',
                ...
                i18n: {
                    en: {
                        ...
                        NEXT: "بعدی",
                        PREV: "قبلی",
                        ERROR: "محتوای این درخواست قابل بارگزاری نمی باشد. <br/> لطفا بعدا امتحان کنید",
                        PLAY_START: "شروع اسلایدشو",
                        PLAY_STOP: "مکث اسلایدشو",
...
function (t, s) {
    ...
    s.fancybox.defaults = s.extend(!0, {
        btnTpl: {
            thumbs: '<button data-fancybox-thumbs class="fancybox-button fancybox-button--thumbs" title="{{THUMBS}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M14.59 14.59h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76h-3.76v-3.76zm-4.47 0h3.76v3.76H5.65v-3.76zm8.909AB67DA13"/></svg></button>'
        },
        thumbs: {
            autoStart: !1,
            hideOnClose: !0,
