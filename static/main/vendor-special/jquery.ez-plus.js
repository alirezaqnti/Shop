    ...
    var EZP = {
        ...
        startZoom: function () {
            ...
            function getInnerZoomStyle() {
                ...
                var borderWidth = self.$elem.css('border-right-width');
                ...
                return 'display: none;' +
                    ...
                    'margin-right: ' + String(borderWidth) + ';' +
                    'border: ' + String(self.options.borderSize) + 'px solid ' + self.options.borderColour + ';' +
                    'background-position: 0px 0px;' +
                    'background-repeat: no-repeat;' +
            ...
            self.zoomWindow = $('<div style="' +
                    ...
                    'right: ' + (self.windowOffsetLeft) + 'px;' +
        ...
        setPosition: function (e) {
            ...
            self.zoomContainer.css({
                ...
                right: self.nzOffset.right,
                width: self.nzWidth, // new code
                height: self.nzHeight // new code
            });
            self.mouseLeft = parseInt(e.pageX - self.nzOffset.right);
            ...
            //else continue with operations
                ...
                if (self.options.zoomType === 'lens') {
                    ...
                    self.windowLeftPos = String(((e.pageX - self.nzOffset.right) * self.widthRatio - self.zoomLens.width() / 2) * (-1));
        ...
        setWindowPosition: function (e) {
            ...
            if (!isNaN(self.options.zoomWindowPosition)) {
                ...
                self.windowOffsetLeft = self.externalContainerOffset.right; //DONE 1, 2, 3, 4, 16
                    ...
                    if (!self.loop) {
                        self.loop = setInterval(function () {
                            ...
                            if (self.scrollingLock) {
                                ...
                                self.xp = ((e.pageX - self.nzOffset.right) * self.widthRatio - self.zoomWindow.width() / 2) * (-1);
        ...
        setTintPosition: function (e) {
            ...
            self.updateOffset(self);
            self.tintpos = String(((e.pageX - self.nzOffset.right) - (zoomLensWidth / 2)) * (-1));
        ...
        updateOffset: function (self) {
            if (self.options.zoomContainerAppendTo != 'body') {
                ...
                self.nzOffset.right = self.$elem.offset().right - appendedPosition.right;
