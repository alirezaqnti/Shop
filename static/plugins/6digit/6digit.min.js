$(function () {
  ...
  // input fields
  var $first = $form.find("input[name=pincode-1]"),
    $second = $form.find("input[name=pincode-2]"),
    $third = $form.find("input[name=pincode-3]"),
    $fourth = $form.find("input[name=pincode-4]"),
    $fifth = $form.find("input[name=pincode-5]"),
    $sixth = $form.find("input[name=pincode-6]");
